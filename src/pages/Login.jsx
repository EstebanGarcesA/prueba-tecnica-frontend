        ...
        <div className="p-8">
          ...
          <form method="POST" action="#" className="mt-8 space-y-6">
            <div className="rounded-md shadow-sm">
              ...
              <div className="mt-4">
                <label className="sr-only" htmlFor="password">Contraseñá</label>
            ...
            <div>
              <button className="group relative w-full flex justify-center py-3 px-4 border border-transparent text-sm font-medium rounded-md text-gray-900 bg-indigo-500 hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" type="submit">
                Inicar Sesion
              </button>
            </div>
          </form>
